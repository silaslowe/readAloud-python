    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='readAloudapi.book')),
                ('topic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='readAloudapi.topic')),
            ],
        ),
        migrations.CreateModel(
            name='BookSkill',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='readAloudapi.book')),
                ('skill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='readAloudapi.skill')),
            ],
        ),
        migrations.AddField(
            model_name='book',
            name='profile',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='readAloudapi.profile'),
        ),
    ]
